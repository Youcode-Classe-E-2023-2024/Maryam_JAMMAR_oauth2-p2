...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            window.location.href = '/users'; // Rediriger vers le tableau de bord après la connexion réussie
        } catch (error) {
                        ...
                        <div className="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
                            ...
                            <form onSubmit={handleSubmit} className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                                ...
                                <button type="submit" className="relative">
                                    <div className="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500 rounded-lg transition duration-200 hover:bg-indigo-600 ease">Submit</div>
                                </button>
                            </form>
                        </div>
