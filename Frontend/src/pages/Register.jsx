...
const Register = ({data}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(response.data); // Vous pouvez faire quelque chose avec la réponse du backend ici
            window.location.href = '/login'; // Correction: chemin relatif pour la redirection
        } catch (error) {
                ...
                <div className="flex flex-col items-center w-full pr-10 pb-20 pl-10 lg:flex-row">
                    ...
                    <div className="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                        <div
                            ...
                            <p className="w-full text-4xl font-medium text-center leading-snug font-serif">Sign up for
                                an account</p>
                            <form onSubmit={handleSubmit} className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                                {/*<form onSubmit={handleSubmit}>*/}
                                    ...
                                    <button type="submit" className="relative">
                                        <div
                                           className="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500 rounded-lg transition duration-200 hover:bg-indigo-600 ease">Submit</div>
                                    </button>
                                {/*</form>*/}
                            </form>
                        </div>
